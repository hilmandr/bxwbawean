    ...
    <>
      <Container className="px-16">
        <div className="my-10 flex w-full flex-col items-center justify-center">
          ...
          <div className="mt-10 grid w-full items-center justify-center gap-8 lg:grid-cols-3">
            {HOME_LAYANAN.map((layanan) => (
              <>
                <div className="flex w-full flex-col items-center justify-between gap-6 text-slate-900">
                  <Link
                    href=""
                    className="flex aspect-video w-full items-center justify-center bg-neutral-700 transition-all duration-200 hover:scale-[1.05]"
                  >
                    <layanan.thumbnail
                      size="150"
                      color="#fafafa"
